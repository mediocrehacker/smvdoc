...
export const meta: MetaFunction = () => {
  return [
    { title: "Соснина Мария Викторовна" },
    {
      name: "description",
      content:
        "Соснина Мария Викторовна, врач-психотерапевт, клинический психолог, практика с 2004г.",
    },
    {
      property: "og:title",
    ...
    },
    {
      ...
      content:
        "Психологическое консультирование, практика с 2004г. Для записи на первичную консультацию писать в Телеграмм или Wats app +79050890284.",
    },
  ];
};
    ...
    <div className="container max-w-4xl mx-auto p-4 md:p-8">
      <div className="flex flex-col gap-8 md:flex-row">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p>
            Для записи на первичную консультацию писать в Телеграмм или Wats app
            {" "}
            <strong>+79050890284</strong>.
          </p>
